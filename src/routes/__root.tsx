...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CarryBridge — Peer-to-peer delivery between Kazakhstan and Europe" },
      { property: "og:description", content: "Verified travelers carry your packages between Kazakhstan and Europe." },
